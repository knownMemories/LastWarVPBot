package com.km.lastwar.vpbot.io;
...
import com.km.lastwar.vpbot.data.Zone;
import com.km.lastwar.vpbot.exception.ScreenIndexException;
...
public class Screen {
	...
	public static Screen getInstance(BotType botType) {
	...
	public void takeScreenShot(String name) {
		String path = Constants.DEBUG_SCREEN_PATH + name + ".png";
		logger.debug("Save screenshot to {}", path);
		screen(path, origX, origY, width + 1, height + 1);
	}
