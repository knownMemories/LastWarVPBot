...
public class ProcessManager {
    ...
    private static String BOT_VP_PROCESS = "C:\\LDPlayer\\LDPlayer9\\" + EMU_PROCESS_NAME + "\" launchex --index 0 --packagename com.fun.lastwar.gp";

    public static void startVPProcess() {
        startProcess(BOT_VP_PROCESS);
    }

    public static void killVPProcess() {
        killProcess(BOT_VP_PROCESS);
        killEmulator();
    }

    public static void restartBotFL() {
        logger.info("restartBotFL");
        ProcessManager.killVPProcess();
